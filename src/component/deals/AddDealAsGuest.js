          ...
          <form onSubmit={this.onSubmit}>
            ...
            <div className="form-group row"> 
                ...
                <div className="form-group col-sm-12 col-md-4">
                    ...
                    <div className="invalid-feedback">{this.state.formErrors.category}</div>
                    {serverErr.category && (<div className="invalid-feedback">{serverErr.category}</div>)}
                </div>
            ...
            <div className="form-group row"> 
                <div className="col-md-8">
                    ...
                    {serverErr.location && (<div className="invalid-feedback">{serverErr.location}</div>)}
                </div>
            ...
            <div className="form-group">
                ...
                <textarea 
                    ...
                    min="5" 
                    className={classnames('form-control form-control-lg', {
                        'is-invalid': serverErr.description
                    })}
                    required className={classnames('form-control form-control-lg', {
